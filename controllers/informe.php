...
class Informe extends Controller {
	...
	function venta_all(){
		...
		$this->view->js = array('informe/js/inf_ven_all.js?v=1');
		$this->view->render('informe/venta/venta', false);
	}

	function venta_all_list()
    {
        print_r(json_encode($this->model->venta_all_list($_POST)));
    }
    ...
    {
        print_r(json_encode($this->model->venta_delivery_list($_POST)));
    }
    ...
    {
        print_r(json_encode($this->model->venta_culqi_list($_POST)));
    }
    ...
    {
        print_r(json_encode($this->model->venta_prod_kardex_list($_POST)));
    }

    function venta_prod_kardex_graphic()
    {
        print_r(json_encode($this->model->venta_prod_kardex_graphic($_POST)));
    }
    ...
    {
        print_r(json_encode($this->model->venta_prod_margen_list($_POST)));
    }
	...
	function venta_cort_list(){
		print_r(json_encode($this->model->venta_cort_list($_POST)));
	}

	function venta_prod_list()
    {
        print_r(json_encode($this->model->venta_prod_list($_POST)));
    }
	...
	function venta_mozo_list(){
		print_r(json_encode($this->model->venta_mozo_list($_POST)));
	}
	...
	function venta_fpago_list(){
		print_r(json_encode($this->model->venta_fpago_list($_POST)));
	}
	...
	function venta_desc_list(){
		print_r(json_encode($this->model->venta_desc_list($_POST)));
	}
	...
	function compra_all_list(){
		print_r(json_encode($this->model->compra_all_list($_POST)));
	}
	...
	function finanza_arq_list(){
		print_r(json_encode($this->model->finanza_arq_list($_POST)));
	}
	...
	function finanza_ing_list(){
		print_r(json_encode($this->model->finanza_ing_list($_POST)));
	}
	...
	function finanza_egr_list(){
		print_r(json_encode($this->model->finanza_egr_list($_POST)));
	}
	...
	function finanza_rem_list(){
		print_r(json_encode($this->model->finanza_rem_list($_POST)));
	}
	...
	function finanza_arq_resumen_imp($id)
    {
        $this->view->empresa = $this->model->Empresa();
        $this->view->dato = $this->model->finanza_arq_resumen_imp($id);
        $this->view->render('informe/finanza/imprimir/imp_cierre_resumen', true);
    }
	...
	function finanza_adel_list_a(){
		print_r(json_encode($this->model->finanza_adel_list_a($_POST)));
	}

	function finanza_adel_list_b(){
		print_r(json_encode($this->model->finanza_adel_list_b($_POST)));
	}
    ...
    {
        print_r(json_encode($this->model->kardex_list($_POST)));
    }
    ...
    {
        print_r(json_encode($this->model->oper_anul_list($_POST)));
    }
