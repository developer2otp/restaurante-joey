...
class Inventario extends Controller {
	...
	{
		print_r(json_encode($this->model->ajuste_list($_POST)));
	}
	...
	function stock_list() 
	{
		print_r(json_encode($this->model->stock_list($_POST)));
	}
	...
	// pdf reparto 
    function impresion_stock()
    {
		$this->view->dato = $this->model->impresion_stock($_GET);
		$this->view->render('inventario/imprimir/stock', true);
    }	
}