...
class Ajuste extends Controller {
	...
	function datosempresa(){
		...
		$this->view->js = array('ajuste/js/wizard/jquery.bootstrap.wizard.js','ajuste/js/wizard/wizard.js','ajuste/js/aju_emp_datos.js');
    ...
    function system(){
        include_once('models/caja_model.php');
        $turn = new Caja_Model;
        $this->view->Turno = $turn->Turno();
        $this->view->title_page = 'System';
		$this->view->js = array('ajuste/js/aju_sis_system.js');
        $this->view->data_list = $this->model->system_data();
		$this->view->render('ajuste/all/system', false);
	}

    function system_save(){
        print_r(json_encode($this->model->system_save($_POST)));
    }

	function tipodoc_list(){
        print_r(json_encode($this->model->tipodoc_list()));
    }
    ...
    {
        print_r(json_encode($this->model->tipopago_list($_POST)));
    }
    ...
    {
        print_r(json_encode($this->model->usuario_list($_POST)));
    }
    ...
    function usuario_crud(){   
        if($_POST['id_usu'] != ''){
           print_r(json_encode($this->model->usuario_crud_update($_POST)));
        } else{
            print_r(json_encode($this->model->usuario_crud_create($_POST)));
        }
    }
    ...
    function terminos(){
        print_r(json_encode($this->model->terminos($_POST)));
    }

    function terminos_listar(){
        print_r(json_encode($this->model->terminos_listar()));
    }
	...
	function caja_list(){
        print_r(json_encode($this->model->caja_list()));
    }
    ...
    {
        print_r(json_encode($this->model->areaprod_list($_POST)));
    }
    ...
    function salon_list()
    {
        print_r(json_encode($this->model->salon_list($_POST)));
    }
    ...
    {
        print_r(json_encode($this->model->producto_cat_list($_POST)));
    }

	function producto_list()
    {
        print_r(json_encode($this->model->producto_list($_POST)));
    }

    function producto_listSolo()
    {
        print_r(json_encode($this->model->producto_listSolo($_POST)));
    }

    function producto_pres_list()
    {
        print_r(json_encode($this->model->producto_pres_list($_POST)));
    }
    ...
    function combo_list()
    {
        print_r(json_encode($this->model->combo_list($_POST)));
    }
    ...
    {
        print_r(json_encode($this->model->insumo_cat_list($_POST)));
    }

    function insumo_list()
    {
        print_r(json_encode($this->model->insumo_list($_POST)));
    }
   ...
   function insumo_cat_crud()
    ...
    function print_list()
    {
        print_r(json_encode($this->model->print_list($_POST)));
    }
    ...
    function importarexcel(){
        print_r(json_encode($this->model->importarexcel()));
    }

    function exportarexcel(){
       $this->model->exportarexcel();
    }

    function importarexcelinsumos(){
        print_r(json_encode($this->model->importarexcelinsumos()));
    }
}