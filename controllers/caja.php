...
class Caja extends Controller {
	...
	{
        print_r(json_encode($this->model->InsertTurno($_POST)));
    }
    ...
    {
        print_r(json_encode($this->model->ingreso_list($_POST)));
    }
    ...
    {
        print_r(json_encode($this->model->egreso_list($_POST)));
    }
    ...
    {
        print_r(json_encode($this->model->monitor_list($_POST)));
    }

    function monitor_ventas_list()
    {
        print_r(json_encode($this->model->monitor_ventas_list()));
    }
