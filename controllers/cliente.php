...
class Cliente extends Controller {
    ...
    {
        print_r(json_encode($this->model->cliente_list($_POST)));
    }

    function cliente_datos(){
        print_r(json_encode($this->model->cliente_datos($_POST)));
    }
    ...
    function cliente_ventas(){
        print_r(json_encode($this->model->cliente_ventas($_POST)));
    }
