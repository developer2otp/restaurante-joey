...
<div id="wrapper-1" style="display: block;">
    ...
    <div class="row auth-wrapper gx-0">
        <div class="col-lg-7 col-xl-8 bg-primary auth-box-2 on-sidebar hidden-md-down" style="background-image:url(<?php echo URL; ?>public/images/background/fondo-newlogin.png); background-size: cover;">
        ...
        <h2 class="text-white mt-4 fw-light"><span class="font-weight-medium text-warning"></span></h2>
        </div>
        <div class="col-md-12 col-lg-5 col-xl-4 d-flex align-items-center justify-content-center">
            <div class="row justify-content-center w-100 mt-1 mt-lg-0 px-5">
                <div class="col-12">
                    <div id="loginform">
                        <img src="<?php echo URL; ?>public/images/login-solutions.png" style="width: 100%;max-width: 250px;margin: 0 auto;display: block;" class="mb-2"/>
                        ...
                        <form class="form-horizontal pt-2" id="frm-login" role="form" method="post">
                            ...
                            <div class="input-group mb-3 form-floating">
                                ...
                                <div class="input-group-append">
                                    <div class="input-group-text">
                                        <span class="fas fa-lock" id="view_password"></span>
                                    </div>
                                </div>
                            </div>
                            <!--
                            ...
                            <div class="button-group px-2">
                                <button type="submit" class="btn btn-warning btn-block btn-lg px-4">Ingresar</button>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="text-center" style="font-size: 12px;">Desarrollado por <?php echo NOMBRE_SOFT;?> REST</div>
                </div>
            </div>
        </div>
    </div>
