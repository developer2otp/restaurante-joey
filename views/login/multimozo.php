    ...
    <div class="row auth-wrapper gx-0">
            ...
            <!-- <div class="h-100 d-flex align-items-center justify-content-center">
                <div class="row justify-content-center text-center">
                    <div class="col-md-7 col-lg-12 col-xl-9">
                        ...
                        <h2 class="text-white mt-4 fw-light">LAFACTURITA <span class="font-weight-medium text-warning">REST</span></h2>
        ...
        <div class="col-md-12 col-lg-5 col-xl-4 d-flex align-items-center justify-content-center">
            <div class="row justify-content-center w-100 mt-1 mt-lg-0 px-5">
                <div class="col-12">
                    <div class="">
                        <img src="<?php echo URL; ?>public/images/soltec.png" style="width: 100%;max-width: 350px;margin: 0 auto;display: block;" class="mb-2"/>
                        ...
                        <div class="text-center" style="font-size: 12px;">SISCOFACT REST Todos los derechos	reservados</div>
