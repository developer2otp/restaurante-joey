        ...
        "columns":[
            ...
            }},
            {
                ...
                "render": function(data, type, row) {
                    var deleteMesasHTML = optionMesa ? '<a href="javascript:void(0)" class="text-danger delete ms-2" onclick="eliminarSalon('+data.id_salon+',\''+data.descripcion+'\');"><i data-feather="trash-2" class="feather-sm fill-white"></i></a>' : '';
...
var listarMesas = function(id_salon,descripcion){
    ...
    .DataTable({
        ...
        "columns":[
            ...
            {"data":null,"render": function ( data, type, row ) {
                var deleteMesasHTML = optionMesa ? '<a href="javascript:void(0)" class="text-danger delete ms-2" onclick="eliminarMesa('+data.id_mesa+',\''+data.nro_mesa+'\');"><i data-feather="trash-2" class="feather-sm fill-white"></i></a>' : '';
