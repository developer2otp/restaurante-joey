	    ...
	    <div class="card p-20">
            ...
            <div class="vtabs customvtab">
                <ul class="nav nav-tabs tabs-vertical" role="tablist" >
					...
					<li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#step6" role="tab" aria-selected="false"><span class="hidden-sm-up"><i class="ti-settings"></i></span> <span class="hidden-xs-down">Configuración</span> </a> </li>
                </ul>
                <!-- Tab panes -->
                            ...
                            <div class="row floating-labels">
	                            <div class="col-md-12">
									...
									<div class="row">
			                            <div class="col-md-6">
			                                <div class="form-group m-b-40 letNumMayMin">
												<select class="custom-select custom-select-sm" id="type_operation" name="type_operation">
												</select>
			                                    <span class="bar"></span>
			                                    <label for="imp_acr"><span class="label label-danger font-13">TIPO DE AFECTACI&Oacute;N</span></label>
			                                </div>
			                            </div>
			                        </div>
