                        ...
                        <div class="row" style="margin-left: -20px; margin-right: -20px">
                            ...
                            <div class="col-lg-7 p-0">
                                <div class="row p-20">
                                    ...
                                    <div class="col-lg-3 mb-3 mb-sm-0">
                                        <a class="btn btn-danger btn-block" href="<?php echo URL.'ajuste/exportarexcel'?>" target="_blank">Exportar</a>
                                    </div>
                                    <div class="col-lg-5">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="btn-group btn-group-toggle w-100" data-toggle="buttons">
                            <label class="btn waves-effect waves-light btn-secondary" id="transf" data-original-title="Producto que has COMPRADO PARA VENDER, Ejm: Gaseosas, chifles" data-toggle="tooltip" data-placement="top">
                                <input type="radio" name="id_tipo" value="1" autocomplete="off"> Transformado
                            </label>
                            <label class="btn waves-effect waves-light btn-secondary" id="ntransf" data-original-title="Producto que debes PREPARAR ANTES DE VENDER, Ejm: Ceviches, parrillas o tragos" data-toggle="tooltip" data-placement="top">
                                <input type="radio" name="id_tipo" value="0" autocomplete="off"> No Transformado
                            </label>
                        </div>
                    </div>
                </div>
