...
<div class="row page-titles">
    <div class="col-md-5 col-8 align-self-center">
        <h3 class="m-b-0 m-t-0">Facturaci&oacute;n Electr&oacute;nica - API Facturador PRO</h3>
        <ol class="breadcrumb">
                    ...
                    <div class="card-body p-b-0">
                        <div class="message-box contact-box">
                                ...
                                <div class="col-sm-6 offset-lg-5 col-lg-2">
                                    <div class="form-group m-b-40">
                                        <select class="selectpicker form-control" name="tipo_doc" id="tipo_doc" data-style="form-control btn-default" data-live-search="true" autocomplete="off" data-size="5">
                                            <option value="all" active>Mostrar Todo</option>
                                            <optgroup>
                                    ...
                                    <div class="form-group m-b-40">
                                        <select class="selectpicker form-control" name="est_doc" id="est_doc" data-style="form-control btn-default" data-live-search="true" autocomplete="off" data-size="5">
                                            ...
                                            <optgroup>
												...
												<option value="05">ACEPTADO SUNAT</option>
                            ...
                            <div class="text-center m-b-20">
                                <div class="row">
                                <div class="col-2">
                                        <h2 class="font-medium text-warning m-b-0 font-30" id="total_aceptados"></h2>
                                        <h6 class="font-bold m-b-10">Aceptados</h6>                            
                                    </div>
                                    <div class="col-2">
                                        <h2 class="font-medium text-warning m-b-0 font-30" id="total_registrados"></h2>
                                        <h6 class="font-bold m-b-10">Registrados</h6>                            
                                    </div>
                                    <div class="col-2">
                                    ...
                                    <!--<div class="col-2">
                                        <h2 class="font-medium text-warning m-b-0 font-30" id="total_xanular"></h2>
                                        <h6 class="font-bold m-b-10">Por anular</h6>
                                    </div>-->
                                    <div class="col-2">
									...
									<div class="col-2">
                                        <h2 class="font-medium text-warning m-b-0 font-30" id="total_rechazados"></h2>
                                        <h6 class="font-bold m-b-10">Rechazados</h6>
                                    </div>
									<div class="col-2">
                                        <h2 class="font-medium text-warning m-b-0 font-30" id="total_observados"></h2>
                                        <h6 class="font-bold m-b-10">Observados</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body p-b-0">
                        <div class="message-box contact-box">
                            ...
                            <div class="row floating-labels">
                                ...
                                <div class="offset-sm-6 col-sm-3">
                                    <div class="form-group">
                                        <button class="btn btn-success btn-block btn-nvo">ENVIAR POR RESUMEN A SUNAT</button>
                                    </div>
                                </div>
                            </div>
                        </div>
