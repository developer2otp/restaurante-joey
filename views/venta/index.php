...
<div class="row u4-2">
    ...
    <li class="nav-item tab01">
        <a class="nav-link active" data-toggle="tab" href="#tabp-1" role="tab">
            <span class="hidden-sm-up">Mesas</span>
            <span class="hidden-xs-down">Mesas</span>
        </a>
    </li>
    <li class="nav-item tab02">
        <a class="nav-link" data-toggle="tab" href="#tabp-2" role="tab" onclick="mostrador()">
            <span class="hidden-sm-up">Mostrador</span>
            <span class="hidden-xs-down">Mostrador</span>
        </a>
    </li>
    <?php if(Session::get('rol') != 10) { ?>
    <li class="nav-item tab03">
        <a class="nav-link" data-toggle="tab" href="#tabp-3" role="tab" onclick="delivery()">
            <span class="hidden-sm-up">Delivery</span>
            <span class="hidden-xs-down">Delivery <span class="label label-rounded label-inverse pedidos-total-1">0</span></span>
        </a>
    </li>
    <?php } ?>
    <li class="nav-item tab04">
    <form id="form-venta-rapida" method="post" enctype="multipart/form-data" action="<?php echo URL; ?>venta/pedido_create/pc2" class="form-inline">
        
        <div class="input-group input-group-sm mt-2 ml-2">
            <div class="input-group-prepend ">
                <span class="input-group-text bg-warning" id="basic-addon1">CLIENTE:</span>
            </div>

            <input type="text" class="form-control form-control-sm input-mayus bg-light" name="nomb_cliente" placeholder="NOMBRE CLIENTE" aria-describedby="basic-addon1">
        </div>
        &nbsp;
        <div class="form-group mt-2">
            <span class="input-group-btn">
                <button class="btn btn-sm btn-primary" type="submit">VENTA RAPIDA</button>
            </span>
            ...
            <div class="tab-content">
                <div class="card-body display-estado-mesa p-t-10 p-b-0">
                    <div class="row">
                        <div class="col-md-6 col-8 align-self-center m-t-5">
                            <small class="label mesas-disponibles" style="background: #79df9d;" data-original-title="Mesa libre" data-toggle="tooltip" data-placement="right"><span id="mesa_libre">&nbsp;</span></small>
                            <small class="label mesas-pago" style="background: #5a9bf3;" data-original-title="En proceso de pago" data-toggle="tooltip" data-placement="right"><span id="mesa_proceso">&nbsp;</span></small>
                            <small class="label mesas-ocupadas" style="background: #e7444c;" data-original-title="Mesa ocupada" data-toggle="tooltip" data-placement="right"><span id="mesa_ocupada">&nbsp;</span></small>

                            <button class="btn mesas-ocupadas btn-sm" style="background: #9925be;" href="#modal-cambiar-mesa" data-toggle="modal" data-placement="right">CAMBIAR MESA</button>
                            <button class="btn mesas-disponibles btn-sm" style="background: #be4d25;" href="#modal-mover-pedidos" data-toggle="modal" data-placement="right">MOVER PEDIDOS</button>
                        </div>
                        ...
                        <div class="tab-content w-100" style="padding-bottom: 10px;">
                            <ul class="nav nav-tabs tabs-horizontal">
                                <?php $cont=1;$cont_salon = 0; foreach($this->Salon as $key => $value): ?>
                                    <li class="nav-item list-salones m-t-10">
                                        <a class="nav-link" data-toggle="tab" href="#tab-<?php echo $value['id_salon']; ?>" role="tab" id="tab<?php echo $cont++; ?>" onclick="mesa_list(<?php echo $value['id_salon']; ?>)">
                                            <span class="font-14"><?php echo $value['descripcion']; ?></span>
                                        </a>
                                    </li>
                                <?php endforeach; ?>
                            </ul>
    ...
    <div class="col-lg-4 u4">
        <div class="card card_height m-b-0" style="background: #3f3f3f; height: 100%;">
            ...
            <div class="card-footer card-footer-right m-t-10" style="display: none">
                <div class="row">
                    <div class="col-12 m-b-10 m-t-5 text-center">
                        <div class="descriptive-icon-2 totalPagar animated fadeIn"></div>
                    </div>
                    <div class="col-12 m-b-5 text-center">
                        <button type="button" class="btn btn-secondary btn-cancelar-pedido hidden-lg-up" data-toggle="tooltip" data-placement="top" data-original-title="Regresar"><i class="fas fa-undo-alt"></i></button>
...
<div id="card2"></div>
<div class="">
    <button class="waves-effect waves-light btn-inverse btn btn-circle btn-sm btn-up hidden-lg-up" style="bottom: 50px"><i class="ti-arrow-circle-up text-white"></i></button>
    <button class="waves-effect waves-light btn-inverse btn btn-circle btn-sm btn-down hidden-lg-up" style="bottom: 10px"><i class="ti-arrow-circle-down text-white"></i></button>
</div>
