...
<!--<input type="hidden" id="pc_ip" value="<?php //echo URL.'/impresion/'; ?>"/>-->
...
<input type="hidden" id="printVentaRapida" value="<?php echo URL_VENTA_RAPIDA;?>"/>
...
<div class="row u4-1">
            ...
            <div class="card-body p-0">
                <div class="tab-pane p-0 active" id="tabp-1" role="tabpanel">
                    <div class="vtabs customvtab w-100">
						...
						<ul class="scroll_categorias nav nav-tabs tabs-horizontal" id="list-catgrs">
                        </ul>
    ...
    <div class="">
        ...
        <button class="waves-effect waves-light btn-inverse btn btn-circle btn-lg btn-up hidden-lg-up" style="bottom: 65px"><i class="ti-arrow-circle-up text-white"></i></button>
        <button class="waves-effect waves-light btn-inverse btn btn-circle btn-lg btn-down hidden-lg-up" style="bottom: 10px"><i class="ti-arrow-circle-down text-white"></i></button>
    </div>
    <!-- Right sidebar -->
    <!-- ============================================================== -->
    <!-- .right-sidebar -->
    ...
    <div class="modal-dialog modal-fullscreen">
        ...
        <input type="hidden" name="total_venta" id="total_venta">
            <div class="modal-header" style="background: #006a71;">
                ...
                <span class="btn btn-danger ml-auto" onClick="reset_form()">POR CONSUMO</span>
            </div>
                        ...
                        <div class="col-md-7 p-t-20" style="background: #fbfdff;">
                            ...
                            <div class="col-lg-12 p-t-10 p-b-20">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="buscar_cliente" id="buscar_cliente" autocomplete="off" value="DNI: 00000000 | PUBLICO EN GENERAL | - | -">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content animated bounceInTop">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-success" id="new_client"><span id="span_new_client">Aceptar</span></button>
            </div>
            </form>
        </div>
    </div>
...
<script id="nvo-ped-det-template" type="text/x-jsrender" src="">
    <tbody class="tb-st">
    {{for items}}
    <tr class="warning-element" style="border-left: 2px solid #ffb22b !important; background: #fefde3;" data-id-row="{{:area_id}}-{{:producto_id}}">
        <td style="width: 100px !important;position: relative;z-index: 0;">
            ...
            <input class="touchspin1 input-sm text-left cantidad-input" type="text" value="{{:cantidad}}" id="cantidad_{{:producto_id}}" name="cantidad" min="1" data-maximo="{{:stock}}" onchange="pedido.actualizar({{:id}}, this);"/>
        </td>
        ...
        <td class="text-right m-l-0" style="width: 100px !important;">
