...
<head>
    ...
    <?php
        ...
        {
            echo '<title>' . NOMBRE_SOFT . ' REST | '.$this->title_page.'</title>';
        }
        else{
            echo '<title>' . NOMBRE_SOFT . ' REST</title>';
        }
    ?>
    ...
    <link href="<?php echo URL; ?>public/css/colors/jb-soft.css?v=<?php echo date('ymd'); ?>" id="theme" rel="stylesheet">
    ...
    <!--Personal sumernote -->
    <link href="<?php echo URL; ?>public/plugins/summernote/dist/summernote.css" rel="stylesheet">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    ...
                    <?php } ?>
                        <!-- Logo icon -->
                        <b>
                            <img src="<?php echo URL; ?>public/images/soltec.png" width="60px" style="margin-top: -5px;"/>
                        </b>
                        <!--End Logo icon -->
						<span><span class="font-18 font-medium text-white"><?php echo NOMBRE_SOFT;?></span> <span class="font-18 font-medium text-warning">REST</span></span>
                    </a>
                </div>

                <div class="navbar-collapse">
                    <ul class="navbar-nav mr-auto mt-md-0 lg-0">
                        <!-- This is  -->
                        ...
                        <li class="nav-item mt-3">
                            <div class="btn-group" role="group" aria-label="Basic example">
                                <button type="button" class="btn bg-info" id="goAtraz" data-toggle="tooltip" title="Atraz"><i class="fa fa-arrow-circle-left fa-lg"></i></button>
                                <button type="button" class="btn bg-info" id="goAdelante" data-toggle="tooltip" title="Regresar"><i class="fa fa-arrow-circle-right fa-lg"></i></button>
                            </div>
                        </li>
                        &nbsp;
                        ...
                        <!--<div class="navbar-collapse">-->
                        <?php if((Session::get('rol') == 1 OR Session::get('rol') == 2 OR Session::get('rol') == 3) AND Session::get('f_pro') == 3) { ?>
                        <li class="nav-item mt-3">
                            <div class="btn-group" role="group" aria-label="Basic example">
                                <button type="button" class="btn bg-warning" onClick="location.href='<?php echo URL;?>venta'" data-toggle="tooltip" title="Vender POS"><span class="btn-label0"><img src="<?php echo URL; ?>public/images/icono-pos.png" width="20px" height="20px"/></span></button>
                                <button type="button" class="btn bg-warning" onClick="location.href='<?php echo URL;?>caja/apercie'" data-toggle="tooltip" title="Caja"><span class="btn-label0"><img src="<?php echo URL; ?>public/images/icono-caja-chica.png" width="20px" height="20px"/></span></button>
                                <button type="button" class="btn bg-warning" onClick="location.href='<?php echo URL;?>informe/finanza_arq'" data-toggle="tooltip" title="Arqueo Caja"><span class="btn-label0"><img src="<?php echo URL; ?>public/images/icono-info-caja.png" width="20px" height="20px"/></span></button>
                            </div>
                        </li>
                        <?php } ?> 
                    </ul>
                    ...
                    <ul class="navbar-nav my-lg-0">
                        <li class="nav-item dropdown">
                            ...
                            <?php } ?>						
                            <?php if((Session::get('rol') == 1 OR Session::get('rol') == 2 OR Session::get('rol') == 3) AND Session::get('f_pro') == 3) { ?>
                            <a href="<?php echo URL; ?>comprobantes"><button class="btn btn-primary waves-effect waves-light border-0" type="button"><span class="btn-label" data-toggle="tooltip" title="Ver documentos API PRO"><img src="<?php echo URL; ?>public/images/logo-peru.png" width="20px" height="20px" /> API Facturador PRO</span> <span class="cont-sunat" data-toggle="tooltip" title="Documentos no enviados"></span></button></a>
                            <?php } ?>                            
