        ...
        <div class="card-group">
            ...
            <div class="card">
                <ul class="nav nav-tabs customtab" role="tablist">
                    ...
                    <!-- AQUI CORREGIR "href" EN CASO SE INSTALE EN LA NUBE-->
                    <li class="nav-item">
                        <a class="nav-link" href="/alpharest/informe/finanza_arq_imp/<?php echo $this->apc; ?>" target="_blank" role="tab" aria-selected="false"><span class="hidden-sm-up"><i data-feather="printer" class="feather-sm fill-white"></i> Imprimir Caja</span> <span class="hidden-xs-down"><i data-feather="printer" class="feather-sm fill-white"></i> Imprimir Caja</span></a>
                    </li>                    
                    <!--
                    <li class="nav-item">
