                ...
                return '<div class="text-right"><div class="btn-group">'
                    +'<a href="javascript::void(0)" class="text-dark" id="new" data-toggle="dropdown" aria-expanded="false"><i data-feather="more-vertical" class="feather-sm"></i></a>'
                        +'<div class="dropdown-menu" x-placement="top-start" style="position: absolute; transform: translate3d(0px, -197px, 0px); top: 0px; left: 0px; will-change: transform;">'
                            +'<a class="dropdown-item" href="'+$('#url').val()+'informe/finanza_arq_resumen/'+data.id_apc+'"><i data-feather="eye" class="feather-sm fill-white"></i> Detalle Caja</a>'
                            +'<a class="dropdown-item" href="'+$("#url").val()+'informe/finanza_arq_imp/'+data.id_apc+'" target="_blank"><i data-feather="printer" class="feather-sm fill-white"></i> Imprimir Caja</a>'
                            +'<a class="dropdown-item" href="'+$("#url").val()+'informe/finanza_arq_resumen_imp/'+data.id_apc+'" target="_blank"><i data-feather="printer" class="feather-sm fill-white"></i> Ranking de Productos</a>'
                        +'</div>'
                    +'</div></div>';
            }}
        ]
